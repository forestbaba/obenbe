<?php if($dataUserType == '1'){?>
    ...
    <div class="global-sidebar-menu-box hvr-underline-from-center"><span style="float: left;margin-right: 10px;"><?php echo $Dot->Dot_SelectedMenuIcon('visited_your_profile');?></span><span class="lt"><?php echo $page_Lang['u_profile_visitors'][$dataUserPageLanguage];?></span><span class="visit_count_ord"><?php echo $Dot->Dot_CheckUserHaveVisitor($uid);?></span></div>
    </a>
    <a href="<?php echo $base_url;?>favourites">
    <div class="global-sidebar-menu-box hvr-underline-from-center"><span style="float: left;margin-right: 10px;"><?php echo $Dot->Dot_SelectedMenuIcon('addFavourite');?></span><span class="lt"><?php echo $page_Lang['favourite_list'][$dataUserPageLanguage];?></span><span class="visit_count_ord"><?php echo $Dot->Dot_CheckUserHaveFavouriteCount($uid);?></span></div>
    </a>  
