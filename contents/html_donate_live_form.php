...
<div class="anm">
  <div class="modalCheckout">
    ...
    <div class="methods_wrapper">
      ...
      <div class="reqirtex">(<?php echo $currencys[$theMainCurrency]; ?>)<?php echo $page_Lang['damount'][$dataUserPageLanguage]; ?></div>
      <div class="methods_con">
        ...
        <div class="method_box_item"><span class="btn green waves-effect waves-purple donate_post_amnt" data-donateid="<?php echo $donateThisPost; ?>" data-u="<?php echo $donateThisUser; ?>" data-type="liveDonate"><?php echo $page_Lang['donate_tpost'][$dataUserPageLanguage]; ?></span></div>
      </div>
    </div>
  </div>
</div>