...
if ($dataUserType == 1) {
	$postDeleteButton = '<div class="post_menu_item hvr-underline-from-center del_post" data-post="' . $dataPostID . '" data-u="' . $dataPostCreatedUserName . '" data-type="deletePostad"><span class="postMenuicon">' . $Dot->Dot_SelectedMenuIcon('delete_icon') . '</span> ' . $page_Lang['delete_post'][$dataUserPageLanguage] . '</div>';
}
	...
	echo '
			   ...
			   <!--Media Player STARTED-->
					<div class="media-wrapper videoPlayr" id="videoPlayer' . $dataPostID . '">
						<video class="vidchaVideo mejs__player el_' . $dataPostID . '" id="player' . $dataPostID . '" data-id="' . $dataPostID . '" width="100%" height="360"style="max-width:100%;" src="' . $base_url . 'uploads/video/' . $VideoData['video_path'] . '.' . $getVideoExtension . '" type="video/mp4" controls preload="none"></video>
					</div>
...
<div class="commentFastButtons h_body<?php echo $dataPostID; ?>">
