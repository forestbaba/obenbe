...
<?php if ($page == 'admin') {?><link rel="stylesheet" href="<?php echo $base_url;?>admin/css/admin<?php echo $styleMode;?>.css" media="screen,projection"><?php }?>
...
<?php if ($hash) {
	...
	<?php if ($page == 'profile') {if ($FriendStatus == 'me') {?>
																						  ...
																						  <?php }}?>
						                  <div class="menu-arrow"></div>
						                  <a href="<?php echo $base_url;?>logout"><div class="header_menu_item hvr-underline-from-center" id="logout-hide"><span class="iti"><?php echo $logoutIcon;
	?></span> <?php echo $page_Lang['logout'][$dataUserPageLanguage];
	?></div></a>
						              </div>
						          </div>
						        </div>
