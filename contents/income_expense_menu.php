...
<div class="earning_menu">
     <?php if($donationFeatureStatus != '0'){?><div class="earning_menu_item <?php echo $earning;?>"><a href="<?php echo $base_url;?>earnings"><?php echo $page_Lang['your_donate_earnings'][$dataUserPageLanguage];?></a></div><?php } ?>
     <?php if($agoreStatus == 1){?><div class="earning_menu_item <?php echo $liveEarn;?>"><a href="<?php echo $base_url;?>earnings?u=live"><?php echo $page_Lang['live_earnings'][$dataUserPageLanguage];?></a></div><?php }?>
