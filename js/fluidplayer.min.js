var fluidPlayerScriptLocation = (function () {
  var e,
    t,
    i = "";
  return (i = document.currentScript
    ? document.currentScript.src
    : ((e = document.getElementsByTagName("script")),
      void 0 !== (t = e[e.length - 1]).getAttribute.length
        ? t.src
        : t.getAttribute("src", -1)))
...
"function" != typeof Object.assign &&
  ...
  (fluidPlayer = function (e, t) {
    ...
    for (var o in fluidPlayerClass)
      fluidPlayerClass.hasOwnProperty(o) &&
        !i(o, fluidPlayerClass.notCloned) &&
        (n[o] = fluidPlayerClass[o]);
...
var fluidPlayerClass = {
  ...
  getMobileOs: function () {
    var e,
      ...
      i = { device: !1, userOs: !1, userOsVer: !1, userOsMajor: !1 };
    if (
      (t.match(/iPad/i)
        ? ((i.device = "iPad"), (i.userOs = "iOS"), (e = t.indexOf("OS ")))
        : t.match(/iPhone/i)
        ? ((i.device = "iPhone"), (i.userOs = "iOS"), (e = t.indexOf("OS ")))
        : t.match(/Android/i)
        ? ((i.userOs = "Android"), (e = t.indexOf("Android ")))
        : (i.userOs = !1),
      "iOS" === i.userOs && -1 < e)
    ) {
      var n = t.substr(e + 3);
      -1 !== n.indexOf(" ") &&
        ((i.userOsVer = n.substring(0, n.indexOf(" ")).replace(/_/g, ".")),
        (i.userOsMajor = parseInt(i.userOsVer)));
    } else
      "Android" === i.userOs && -1 < e
        ? (i.userOsVer = t.substr(e + 8, 3))
        : (i.userOsVer = !1);
    return i;
  },
    ...
    try {
      (n.browserName = navigator.appName),
        -1 != (e = i.indexOf("OPR/"))
          ...
          : -1 != (e = i.indexOf("Opera"))
          ? ((n.browserName = "Opera"),
            (n.fullVersion = i.substring(e + 6)),
            -1 != (e = i.indexOf("Version")) &&
              (n.fullVersion = i.substring(e + 8)))
          : -1 != (e = i.indexOf("MSIE"))
          ? ((n.browserName = "Microsoft Internet Explorer"),
            (n.fullVersion = i.substring(e + 5)))
          : -1 != (e = i.indexOf("Chrome"))
          ? ((n.browserName = "Google Chrome"),
            (n.fullVersion = i.substring(e + 7)))
          ...
          ? ((n.browserName = "Mozilla Firefox"),
            (n.fullVersion = i.substring(e + 8)))
          : (t = i.lastIndexOf(" ") + 1) < (e = i.lastIndexOf("/")) &&
            ((n.browserName = i.substring(t, e)),
            (n.fullVersion = i.substring(e + 1)),
            n.browserName.toLowerCase() == n.browserName.toUpperCase() &&
              (n.browserName = navigator.appName)),
        -1 != (t = n.fullVersion.indexOf(";")) &&
          (n.fullVersion = n.fullVersion.substring(0, t)),
        -1 != (t = n.fullVersion.indexOf(" ")) &&
          (n.fullVersion = n.fullVersion.substring(0, t)),
        (n.majorVersion = parseInt("" + n.fullVersion, 10)),
        isNaN(n.majorVersion) &&
          ((n.fullVersion = "" + parseFloat(navigator.appVersion)),
          (n.majorVersion = parseInt(navigator.appVersion, 10)));
    } catch (e) {}
    return n;
  },
  ...
  getDurationFromNonLinear: function (e) {
    ...
    return (
      i.length &&
        void 0 !== i[0].getAttribute("minSuggestedDuration") &&
        (t = this.convertTimeStringToSeconds(
          i[0].getAttribute("minSuggestedDuration")
        )),
      t
    );
  },
  getDimensionFromNonLinear: function (e) {
    ...
    return (
      i.length &&
        (void 0 !== i[0].getAttribute("width") &&
          (t.width = i[0].getAttribute("width")),
        void 0 !== i[0].getAttribute("height") &&
          (t.height = i[0].getAttribute("height"))),
      t
    );
  },
  ...
  getIconClickThroughFromLinear: function (e) {
    ...
    return t.length
      ? this.extractNodeData(t[0])
      : ((this.displayOptions.vastOptions.adCTAText = !1), "");
  },
  getStaticResourceFromNonLinear: function (e) {
    for (
      var t, i = this.getStaticResourcesFromNonLinear(e), n = 0;
      n < i.length;
      n++
    )
      if (
        (i[n].getAttribute("type") || (t = this.extractNodeData(i[n])),
        i[n].getAttribute("type") === this.displayOptions.staticResource)
      )
        return this.extractNodeData(i[n]);
    return t;
  },
  registerTrackingEvents: function (e, t) {
    for (
      var i = this.getTrackingFromLinear(e), n = "", o = 0, a = 0;
      a < i.length;
      a++
    )
      switch ((n = i[a].getAttribute("event"))) {
        ...
        case "complete":
          void 0 === t.tracking[n] && (t.tracking[n] = []),
            void 0 === t.stopTracking[n] && (t.stopTracking[n] = []),
            t.tracking[n].push(i[a].childNodes[0].nodeValue),
            (t.stopTracking[n] = !1);
          break;
        case "progress":
          void 0 === t.tracking[n] && (t.tracking[n] = []),
            (o = this.convertTimeStringToSeconds(i[a].getAttribute("offset"))),
            void 0 === t.tracking[n][o] &&
              (t.tracking[n][o] = { elements: [], stopTracking: !1 }),
  ...
  prepareVast: function (e) {
    ...
    for (var o = 0; o < n.length; o++) {
      var a = n[o];
      !0 !== t.adList[a].vastLoaded &&
        !0 !== t.adList[a].error &&
        (t.processUrl(t.adList[a].vastTag, a),
        i.addEventListener("adId_" + a, t[e]));
    }
  },
  ...
  playMainVideoWhenVastFails: function (e) {
    ...
    i.removeEventListener("loadedmetadata", t.switchPlayerToVastMode),
      ...
      t.vastOptions && void 0 !== this.vastOptions.errorUrl
        ? t.announceError(e)
        : t.announceLocalError(e),
      t.switchToMainVideo();
  },
    ...
    if (e) {
      ...
      if (void 0 !== l && l.length) {
        ...
        if (null != r && r.length) {
          ...
          n.registerClickTracking(d, i),
            !n.hasVastAdTagUri(e) &&
              n.hasInLine(e) &&
              ((i.adFinished = !1),
              (i.adType = "linear"),
              (i.skipoffset = n.convertTimeStringToSeconds(
                s.getAttribute("skipoffset")
              )),
              (i.clickthroughUrl = n.getClickThroughUrlFromLinear(s)),
              (i.duration = n.getDurationFromLinear(s)),
              (i.mediaFile = n.getMediaFileFromLinear(s)),
              (i.iconClick = n.getIconClickThroughFromLinear(s)));
        }
        void 0 !== i.iconClick &&
          null !== i.iconClick &&
          i.iconClick.length &&
          (n.adList[t].landingPage = i.iconClick);
        ...
        if (null != u && u.length) {
          ...
          n.registerClickTracking(d, i),
            !n.hasVastAdTagUri(e) &&
              n.hasInLine(e) &&
              ((i.adType = "nonLinear"),
              (i.clickthroughUrl = n.getClickThroughUrlFromNonLinear(c)),
              (i.duration = n.getDurationFromNonLinear(c)),
              (i.dimension = n.getDimensionFromNonLinear(c)),
              (i.staticResource = n.getStaticResourceFromNonLinear(c)),
              (i.creativeType = n.getCreativeTypeFromStaticResources(c)));
        }
        if (!n.hasVastAdTagUri(e) && n.hasInLine(e))
          if (
            ((n.adList[t].adType = i.adType ? i.adType : "unknown"),
            void 0 !== i.mediaFile || void 0 !== i.staticResource)
          ) {
            (n.adList[t].vastLoaded = !0), (n.adPool[t] = Object.assign({}, i));
            var y = document.createEvent("Event");
            if (
              (y.initEvent("adId_" + t, !1, !0),
              document.getElementById(n.videoPlayerId).dispatchEvent(y),
              n.displayOptions.vastOptions.vastAdvanced.vastLoadedCallback(),
              n.hasTitle())
            )
              document.getElementById(
                n.videoPlayerId + "_title"
              ).style.display = "none";
  ...
  resolveVastTag: function (e, n, o, a) {
    var l = this;
    if (e && "" != e) {
      n <= l.displayOptions.vastOptions.maxAllowedVastTagRedirects &&
        l.sendRequest(
          e,
          !0,
          l.displayOptions.vastOptions.vastTimeout,
          function () {
            var e = this;
              ...
              if (4 !== e.readyState || 0 !== e.status) {
                if (4 === e.readyState && 200 === e.status)
                  if (4 !== e.readyState || 200 === e.status) {
                    ...
                    if (t) {
                      if (
                        ((l.inLineFound = l.hasInLine(t)),
                        !l.inLineFound && l.hasVastAdTagUri(t))
                      ) {
                      ...
                      n >
                        l.displayOptions.vastOptions
                          .maxAllowedVastTagRedirects && !l.inLineFound
                        ? l.stopProcessAndReportError(o)
                        : l.processVastXml(t, o, a);
  ...
  stopProcessAndReportError: function (e) {
    (this.adList[e].error = !0),
      void 0 !== e && "preRoll" == this.adList[e].roll
        ? this.playMainVideoWhenVastFails(900)
        : this.announceLocalError(101);
  },
  playRoll: function (e) {
    var t = this,
      i = document.getElementById(t.videoPlayerId);
      ...
      switch (((t.vastOptions = t.adPool[e]), n)) {
        ...
        case "postRoll":
          (i.mainVideoCurrentTime = 0),
            (t.autoplayAfterAd = !1),
            (i.currentTime = t.mainVideoDuration);
      }
      var o,
        a = function () {
          if (t.adFinished) i.removeEventListener("timeupdate", a);
            ...
            0 != t.vastOptions.duration &&
              t.scheduleTrackingEvent(e, t.vastOptions.duration),
              e >= t.vastOptions.duration - 1 &&
                0 != t.vastOptions.duration &&
                (i.removeEventListener("timeupdate", a), (t.adFinished = !0));
          }
        };
      (o = e),
        (t.switchPlayerToVastMode = function () {
          if (
            (t.vastOptions.duration || (t.vastOptions.duration = i.duration),
            (void 0 !== t.adList[o].adClickable
              ? t.adList[o].adClickable
              : t.displayOptions.vastOptions.adClickable) &&
              t.addClickthroughLayer(t.videoPlayerId),
            !1 !== t.vastOptions.skipoffset && t.addSkipButton(),
            (i.loop = !1),
            t.addCTAButton(t.adList[o].landingPage),
            t.addAdCountdown(),
            i.removeAttribute("controls"),
            t.vastLogoBehaviour(!0),
            null !==
              document.getElementById(
              ...
              (document.getElementById(
                ...
                t.displayOptions.layoutControls.adProgressColor),
            t.displayOptions.vastOptions.adText || t.adList[o].adText)
          ) {
            var e =
              null !== t.adList[o].adText
                ? t.adList[o].adText
                : t.displayOptions.vastOptions.adText;
            t.addAdPlayingText(e);
          }
          t.positionTextElements(t.adList[o]),
            t.toggleLoader(!1),
            (t.adList[o].played = !0),
            (t.adFinished = !1),
            i.play(),
            t.trackSingleEvent("impression"),
            i.removeEventListener("loadedmetadata", t.switchPlayerToVastMode);
        }),
        i.pause(),
        i.addEventListener("loadedmetadata", t.switchPlayerToVastMode),
        (t.mainVideoCurrentTime = i.currentTime),
        t.detachStreamers(),
        (i.src = t.vastOptions.mediaFile),
        (t.isCurrentlyPlayingAd = !0),
        t.displayOptions.vastOptions.showProgressbarMarkers &&
          t.hideAdMarkers(),
        i.load(),
        i.addEventListener("ended", t.onVastAdEnded),
  ...
  scheduleTrackingEvent: function (e, t) {
    ...
    0 == e && i.trackSingleEvent("start"),
      void 0 !== i.vastOptions.tracking.progress &&
        i.vastOptions.tracking.progress.length &&
        void 0 !== i.vastOptions.tracking.progress[e] &&
        i.trackSingleEvent("progress", e),
  ...
  trackSingleEvent: function (e, i) {
    ...
    if (void 0 !== n.vastOptions && null !== n.vastOptions) {
      ...
      switch (((o.length = 0), e)) {
        ...
        case "thirdQuartile":
        case "complete":
          !1 === n.vastOptions.stopTracking[e] &&
            (null !== n.vastOptions.tracking[e] &&
              (o = n.vastOptions.tracking[e]),
            (n.vastOptions.stopTracking[e] = !0));
          break;
        case "progress":
          n.vastOptions.tracking.progress[i].elements.forEach(function (e, t) {
            !1 === n.vastOptions.tracking.progress[i].stopTracking &&
              n.vastOptions.tracking.progress[i].elements.length &&
              (o = n.vastOptions.tracking.progress[i].elements),
              (n.vastOptions.tracking.progress[i].stopTracking = !0);
          });
          break;
        case "impression":
          void 0 !== n.vastOptions.impression &&
            null !== n.vastOptions.impression &&
            "unknown" != typeof n.vastOptions.impression.length &&
            (o = n.vastOptions.impression);
      }
      n.callUris(o);
    }
  },
  completeNonLinearStatic: function (e) {
    ...
    t.closeNonLinear(e),
      0 == t.adFinished &&
        ((t.adFinished = !0), t.trackSingleEvent("complete")),
      clearInterval(t.nonLinearTracking);
  },
  createNonLinearStatic: function (e) {
    var t = this,
      i = document.getElementById(t.videoPlayerId);
    if (t.adPool.hasOwnProperty(e) && !0 !== t.adPool[e].error) {
      (t.vastOptions = t.adPool[e]),
        t.createBoard(e),
        (t.adFinished = !1),
        t.trackSingleEvent("start");
      var n = t.adList[e].nonLinearDuration
        ? t.adList[e].nonLinearDuration
        : t.vastOptions.duration;
      (t.nonLinearTracking = setInterval(function () {
        ...
        (time = parseInt(t.getCurrentTime()) + parseInt(n)),
        t.scheduleTask({ time: time, closeStaticAd: e });
    } else t.announceLocalError(101);
  },
  createBoard: function (e) {
    var t = this,
      i = t.adPool[e];
    if (
      void 0 !== i.staticResource &&
      -1 !== t.supportedStaticTypes.indexOf(i.creativeType)
    ) {
      t.adList[e].played = !0;
      var n = document.getElementById(t.videoPlayerId),
        ...
        r = new Image();
      (r.src = i.staticResource),
        (r.id = "fluid_nonLinear_imgCreative_" + e + "_" + t.videoPlayerId),
        (r.onload = function () {
          void 0 !== t.adList[e].size
            ? ((origWidth = t.adList[e].size.split("x")[0]),
              (origHeight = t.adList[e].size.split("x")[1]))
            : i.dimension.width && i.dimension.height
            ? ((origWidth = i.dimension.width),
              (origHeight = i.dimension.height))
            : ((origWidth = r.width), (origHeight = r.height)),
            origWidth > o
              ? ((newBannerWidth = o - 5),
                (newBannerHeight = (origHeight * newBannerWidth) / origWidth))
              : ((newBannerWidth = origWidth), (newBannerHeight = origHeight)),
            (img = document.getElementById(r.id)),
            (img.width = newBannerWidth),
            (img.height = newBannerHeight),
            t.trackSingleEvent("impression");
        }),
        (a.id = "fluid_nonLinear_" + e),
        (a.className = "fluid_nonLinear_" + l),
        (a.innerHTML = r.outerHTML),
        (a.onclick = function () {
          void 0 !== i.clickthroughUrl && window.open(i.clickthroughUrl),
            void 0 !== i.clicktracking && t.callUris([i.clicktracking]);
        }),
        void 0 !== i.clickthroughUrl && (a.style.cursor = "pointer");
      var s = document.createElement("div");
      (s.id = "close_button_" + t.videoPlayerId),
        (s.className = "close_button"),
        (s.innerHTML = ""),
        (s.title = t.displayOptions.layoutControls.closeButtonCaption),
        (s.onclick = function (e) {
          return (
            this.parentElement.remove(t),
  ...
  preRoll: function (e) {
    ...
    document
      ...
      .removeEventListener(e.type, t.preRoll),
      (t.firstPlayLaunched = !0);
    var i = e.type.replace("adId_", "");
    !0 !== t.adList[i].played &&
      ("linear" == t.adList[i].adType && (t.toggleLoader(!0), t.playRoll(i)),
      "nonLinear" == t.adList[i].adType &&
        (t.switchToMainVideo(), t.createNonLinearStatic(i)));
  },
  createAdMarker: function (e, t) {
    var i = document.getElementById(this.videoPlayerId + "_ad_markers_holder"),
      n = document.createElement("div");
    (n.id = "ad_marker_" + this.videoPlayerId + "_" + e),
      (n.className = "fluid_controls_ad_marker"),
      (n.style.left = (t / this.mainVideoDuration) * 100 + "%"),
      this.isCurrentlyPlayingAd && (n.style.display = "none"),
      i.appendChild(n);
  },
  hideAdMarker: function (e) {
    var t = document.getElementById(
      "ad_marker_" + this.videoPlayerId + "_" + e
    );
  ...
  showAdMarkers: function () {
    for (
      var e = document
          .getElementById(this.videoPlayerId + "_ad_markers_holder")
          .getElementsByClassName("fluid_controls_ad_marker"),
        t = "ad_marker_" + this.videoPlayerId + "_",
        i = 0;
      i < e.length;
      ++i
    ) {
  ...
  midRoll: function (e) {
    ...
    document
      .getElementById(this.getAttribute("id"))
      .removeEventListener(e.type, t.midRoll);
    var i = e.type.replace("adId_", "");
    if (!0 !== t.adList[i].played) {
      ...
      "string" == typeof n &&
        -1 !== n.indexOf("%") &&
        ((n = n.replace("%", "")),
        (n = Math.floor((t.mainVideoDuration / 100) * n))),
        t.displayOptions.vastOptions.showProgressbarMarkers &&
          "nonLinear" === t.adList[i].adType &&
          t.createAdMarker(i, n),
        t.scheduleTask({ time: n, playRoll: "midRoll", adListId: i });
    }
  },
  postRoll: function (e) {
    var t = fluidPlayerClass.getInstanceById(this.id);
    document
      .getElementById(this.getAttribute("id"))
      .removeEventListener(e.type, t.postRoll);
    var i = e.type.replace("adId_", "");
    t.scheduleTask({
  ...
  onPauseRoll: function (e) {
    ...
    document
      .getElementById(this.getAttribute("id"))
      .removeEventListener(e.type, t.onPauseRoll);
    var i = e.type.replace("adId_", "");
    if ("nonLinear" == t.adList[i].adType) {
      if (!t.adPool.hasOwnProperty(i) || !0 === t.adPool[i].error)
        return void t.announceLocalError(101);
      t.createBoard(i),
        (onPauseAd = document.getElementById("fluid_nonLinear_" + i)),
  ...
  toggleOnPauseAd: function () {
    ...
    e.hasValidOnPauseAd() &&
      ...
      ((onPauseRoll = e.findRoll("onPauseRoll")),
      (adListId = onPauseRoll[0]),
      (e.vastOptions = e.adPool[adListId]),
      (onPauseAd = document.getElementById("fluid_nonLinear_" + adListId)),
      onPauseAd && t.paused
        ? ((onPauseAd.style.display = "flex"),
          (e.adList[adListId].played = !1),
          e.trackingOnPauseNonLinearAd(adListId, "start"))
        : onPauseAd &&
          !t.paused &&
          ((onPauseAd.style.display = "none"),
          (e.adFinished = !0),
          e.trackingOnPauseNonLinearAd(adListId, "complete")));
  },
  trackingOnPauseNonLinearAd: function (e, t) {
    var i = this;
    i.adPool.hasOwnProperty(e) && !0 !== i.adPool[e].error
      ? ((i.vastOptions = i.adPool[e]), i.trackSingleEvent(t))
      : i.announceLocalError(101);
  },
  adTimer: function () {
    var n = this;
    1 != n.isTimer &&
      ...
      (n.timer = setInterval(function () {
        for (var e in n.timerPool)
          if (
            ((time = Math.floor(n.getCurrentTime())),
            time == e && !n.isCurrentlyPlayingAd)
          ) {
            if (n.timerPool[e] && n.timerPool[e].hasOwnProperty("playRoll")) {
              ...
              0 == n.adList[t].played &&
                ...
                "linear" == n.vastOptions.adType &&
                  (n.toggleLoader(!0), n.playRoll(t)),
                "nonLinear" == n.vastOptions.adType &&
                  (n.createNonLinearStatic(t),
                  n.displayOptions.vastOptions.showProgressbarMarkers &&
                    n.hideAdMarker(t)),
                delete n.timerPool[e]);
            }
            if (
              n.timerPool[e] &&
              n.timerPool[e].hasOwnProperty("closeStaticAd")
            ) {
              var i = n.timerPool[e].closeStaticAd;
              1 == n.adList[i].played &&
                (n.completeNonLinearStatic(i), delete n.timerPool[e]);
            }
          }
      }, 800)));
  },
  ...
  switchToMainVideo: function () {
    ...
    t.hasOwnProperty("currentTime") && (t.currentTime = i),
      ...
      null !==
        ...
        ((backgroundColor = e.displayOptions.layoutControls.primaryColor
          ? e.displayOptions.layoutControls.primaryColor
          : "white"),
        (document.getElementById(
          e.videoPlayerId + "_vast_control_currentprogress"
        ).style.backgroundColor = backgroundColor)),
      t.removeEventListener("ended", e.onVastAdEnded),
      e.displayOptions.vastOptions.showProgressbarMarkers && e.showAdMarkers(),
      e.hasTitle() &&
        (document.getElementById(e.videoPlayerId + "_title").style.display =
          "inline");
  },
  ...
  onMainVideoEnded: function () {
    ...
    if (
      !(
        (e.isCurrentlyPlayingAd && e.autoplayAfterAd) ||
        (Math.floor(e.getCurrentTime()) >= Math.floor(e.mainVideoDuration) &&
          clearInterval(e.timer),
        !0 !== e.displayOptions.layoutControls.loop)
      )
    ) {
      var t = fluidPlayerClass.getInstanceIdByWrapperId(
  ...
  getCurrentTime: function () {
    return this.isCurrentlyPlayingAd
      ...
      : document.getElementById(this.videoPlayerId).currentTime;
  },
  addSkipButton: function () {
    ...
    (t.id = "skip_button_" + this.videoPlayerId),
      ...
      (t.innerHTML = this.displayOptions.vastOptions.skipButtonCaption.replace(
        "[seconds]",
        this.vastOptions.skipoffset
      )),
      document
        .getElementById("fluid_video_wrapper_" + this.videoPlayerId)
        .appendChild(t),
  ...
  decreaseAdCountdown: function () {
    ...
    i
      ? (i.innerHTML =
          "Ad - " + e.pad(parseInt(t / 60)) + ":" + e.pad(parseInt(t % 60)))
      : this.removeEventListener("timeupdate", e.decreaseAdCountdown);
  },
  ...
  addAdPlayingText: function (e) {
    ...
    (t.id = this.videoPlayerId + "_fluid_ad_playing"),
      this.displayOptions.layoutControls.primaryColor &&
        ((t.style.backgroundColor = this.displayOptions.layoutControls.primaryColor),
        (t.style.opacity = 1)),
  ...
  positionTextElements: function (e) {
    ...
    null !== n &&
      ((d = n.offsetHeight + 8),
      document
        .getElementById("fluid_video_wrapper_" + t.videoPlayerId)
        .classList.contains("mobile") &&
        ((c.bottom.left.v = 75), (c.bottom.right.v = 75)));
    if (null !== a) {
      var y = t.displayOptions.vastOptions.adCTATextPosition.toLowerCase();
      -1 == i.indexOf(y) &&
        (console.log(
          '[FP Error] Invalid position for CTAText. Reverting to "bottom right"'
        ),
        (y = "bottom right")),
        (s = "bottom" == (u = y.split(" "))[0]),
        (a.style[u[0]] = c[u[0]][u[1]].v + "px"),
        (a.style[u[1]] = c[u[0]][u[1]].h + "px"),
        s && "right" == u[1] && (a.style[u[0]] = c[u[0]][u[1]].v + d + "px"),
        (l = a.offsetHeight + 8 + "px");
    }
    if (null !== o) {
      var p =
        null !== e.adTextPosition
          ? e.adTextPosition.toLowerCase()
      ...
      -1 == i.indexOf(p) &&
        ...
        (p = "top left"));
      var m = p.split(" ");
      (o.style[m[0]] = c[m[0]][m[1]].v + "px"),
        (o.style[m[1]] = c[m[0]][m[1]].h + "px"),
        (r = o.offsetHeight + 8 + "px");
    }
    0 < l &&
      0 < r &&
      y == p &&
      (s
        ? "right" == u[1]
          ? (o.style.bottom = c[m[0]][m[1]].v + d + l + "px")
          : (o.style.bottom = c[m[0]][m[1]].v + l + "px")
        : (a.style.top = c[u[0]][u[1]].v + r + "px"));
  },
  ...
  addCTAButton: function (e) {
    if (this.displayOptions.vastOptions.adCTAText) {
      var t = this,
        i = document.getElementById(this.videoPlayerId),
        n = document.createElement("div");
      (n.id = this.videoPlayerId + "_fluid_cta"),
      ...
      (o.innerHTML =
        ...
        n.addEventListener(
          ...
          function () {
            return (
              i.paused || i.pause(),
              window.open(t.vastOptions.clickthroughUrl, "_blank").focus(),
              !0
            );
          },
          !1
  ...
  decreaseSkipOffset: function () {
    ...
    n
      ? 1 <= i
        ? (n.innerHTML = t.displayOptions.vastOptions.skipButtonCaption.replace(
            "[seconds]",
            i
          ))
        : ((n.innerHTML =
            ...
            t.videoPlayerId +
            "').pressSkipButton();\">" +
            t.displayOptions.vastOptions.skipButtonClickCaption +
            "</a>"),
          (n.className = n.className.replace(/\bskip_button_disabled\b/, "")),
          e.removeEventListener("timeupdate", t.decreaseSkipOffset))
  ...
  pressSkipButton: function () {
    ...
    e.initEvent("ended", !1, !0),
      document.getElementById(this.videoPlayerId).dispatchEvent(e);
  },
  ...
  removeClickthrough: function () {
    var e = document.getElementById(
      "vast_clickthrough_layer_" + this.videoPlayerId
    );
  ...
  getCurrentSrcType: function () {
    ...
    if (e.length)
      for (var t = 0; t < e.length; t++)
        if (e[t].getAttribute("src") == this.originalSrc)
          return e[t].getAttribute("type");
    return null;
  },
  ...
  generateCustomControlTags: function () {
    return (
      ...
      this.videoPlayerId +
      '_ad_markers_holder" class="fluid_controls_ad_markers_holder"></div></div><span class="fluid_controls_right">   <div id="' +
      this.videoPlayerId +
      '_fluid_control_fullscreen" class="fluid_button fluid_button_fullscreen"></div>   <div id="' +
      this.videoPlayerId +
      '_fluid_control_theatre" class="fluid_button fluid_button_theatre"></div>   <div id="' +
      this.videoPlayerId +
      ...
      this.videoPlayerId +
      '_fluid_control_mute" class="fluid_button fluid_button_volume"></div>   <div id="' +
      this.videoPlayerId +
      '_fluid_control_duration" class="fluid_fluid_control_duration">00:00 / 00:00</div></span>'
    );
  },
  controlPlayPauseToggle: function (e) {
    var t = document.getElementById(e + "_fluid_control_playpause"),
      ...
      o = document.getElementById(
        n.videoPlayerId + "_fluid_controls_container"
      ),
      a = document.getElementById(n.videoPlayerId + "_logo"),
      l = document.getElementById(n.videoPlayerId);
    document.getElementById(e + "_fluid_initial_play") &&
      ((document.getElementById(e + "_fluid_initial_play").style.display =
        "none"),
      (document.getElementById(e + "_fluid_initial_play_button").style.opacity =
        "1")),
      l.paused
        ? ((t.className = t.className.replace(
          ...
          o.classList.add("initial_controls_show"),
          this.isCurrentlyPlayingAd &&
            n.displayOptions.vastOptions.showPlayButton &&
            ((document.getElementById(e + "_fluid_initial_play").style.display =
              "block"),
            (document.getElementById(
              e + "_fluid_initial_play_button"
            ).style.opacity = "1")),
          a && a.classList.add("initial_controls_show"),
          null !== i && (i.innerHTML = this.displayOptions.captions.play))
        : ((t.className = t.className.replace(
            /\bfluid_button_play\b/g,
            "fluid_button_pause"
          )),
          o.classList.remove("initial_controls_show"),
          a && a.classList.remove("initial_controls_show"),
          null !== i && (i.innerHTML = this.displayOptions.captions.pause));
  },
  playPauseAnimationToggle: function (e) {
    if (
      ...
      (videoPlayerId = this.videoPlayerId),
        ...
        document
          .getElementById(videoPlayerId + "_fluid_initial_play")
          .classList.add("transform-active");
      var t = videoPlayerId;
      setTimeout(function () {
        document
          .getElementById(t + "_fluid_initial_play")
  ...
  contolProgressbarUpdate: function (e) {
    ...
    document.getElementById(e + "_vast_control_currentprogress").style.width =
      (i.currentTime / t.currentVideoDuration) * 100 + "%";
  },
  ...
  contolDurationUpdate: function (e) {
    var t = fluidPlayerClass.getInstanceById(e),
      i = document.getElementById(e),
      n =
        t.formatTime(i.currentTime) +
        " / " +
        t.formatTime(t.currentVideoDuration);
  ...
  contolVolumebarUpdate: function (e) {
    ...
    i.volume && ((t.latestVolume = i.volume), (t.fluidStorage.fluidMute = !1)),
      i.volume && !i.muted
      ...
      (n.style.width = i.volume * a + "px"),
      (o.style.left = i.volume * a - l / 2 + "px");
  },
  muteToggle: function (e) {
    var t = fluidPlayerClass.getInstanceById(e),
      i = document.getElementById(e);
    i.volume && !i.muted
      ? ((i.volume = 0), (i.muted = !0))
      : ((i.volume = t.latestVolume), (i.muted = !1)),
      (this.fluidStorage.fluidVolume = t.latestVolume),
      (this.fluidStorage.fluidMute = i.muted);
  },
  ...
  fullscreenOn: function (e, t) {
    (e.className = e.className.replace(
      ...
      null !== t && (t.innerHTML = this.displayOptions.captions.exitFullscreen),
      (this.fullscreenMode = !0);
  },
  fullscreenToggle: function () {
    fluidPlayerClass.activeVideoPlayerId = this.videoPlayerId;
    var e = document.getElementById(
        "fluid_video_wrapper_" + this.videoPlayerId
      ),
      t = this.checkFullscreenSupport(
        "fluid_video_wrapper_" + this.videoPlayerId
      ),
      i = document.getElementById(
        this.videoPlayerId + "_fluid_control_fullscreen"
      ),
      n = document.getElementById(
        this.videoPlayerId + "context_option_fullscreen"
      ),
      o = document.getElementById(this.videoPlayerId);
    if ((this.theatreMode && this.theatreToggle(), t))
      switch (t.goFullscreen) {
        case "webkitEnterFullscreen":
          o[t.isFullscreen] ||
            ((functionNameToExecute =
              "videoPlayerTag." + t.goFullscreen + "();"),
            this.fullscreenOn(i, n),
            new Function("videoPlayerTag", functionNameToExecute)(o));
          break;
        default:
          null === document[t.isFullscreen]
            ? ((functionNameToExecute =
                "videoPlayerTag." + t.goFullscreen + "();"),
              this.fullscreenOn(i, n))
            : ((functionNameToExecute = "document." + t.exitFullscreen + "();"),
              this.fullscreenOff(i, n)),
            new Function("videoPlayerTag", functionNameToExecute)(e);
      }
    else
      -1 !== e.className.search(/\bpseudo_fullscreen\b/g)
        ? ((e.className = e.className.replace(/\bpseudo_fullscreen\b/g, "")),
          this.fullscreenOff(i, n))
        : ((e.className += " pseudo_fullscreen"), this.fullscreenOn(i, n));
  },
    ...
    for (var i = 0, n = 0; t && !isNaN(t.offsetLeft); )
      (n = fluidPlayerClass.getTranslateX(t)),
        "BODY" === t.tagName
          ...
          : (i += t.offsetLeft + t.clientLeft + n - t.scrollLeft),
        (t = t.offsetParent);
    return (
  ...
  getEventOffsetY: function (e, t) {
    var i = 1,
      n = fluidPlayerClass.findClosestParent(
        t,
        'div[id^="fluid_video_wrapper_"]'
      );
    if (n) {
    ...
    for (var l = 0; t && !isNaN(t.offsetTop); )
      "BODY" === t.tagName
        ? (l +=
            t.offsetTop -
            (t.scrollTop || document.documentElement.scrollTop) * i)
        : (l += t.offsetTop - t.scrollTop * i),
        (t = t.offsetParent);
    return e.clientY - l;
  },
  onProgressbarMouseDown: function (i, e) {
    ...
    var o = fluidPlayerClass.getEventOffsetX(
      e,
      document.getElementById(i + "_fluid_controls_progress_container")
    );
    ...
    function r(e, t) {
      var i = document.getElementById(e + "_fluid_controls_progress_container")
        .clientWidth;
      i && (a.currentTime = (n.currentVideoDuration * t) / i);
    }
    function s(e) {
      var t = fluidPlayerClass.getEventOffsetX(
        e,
        document.getElementById(i + "_fluid_controls_progress_container")
      );
      (o = NaN),
        r(i, t),
        n.contolProgressbarUpdate(n.videoPlayerId),
        n.contolDurationUpdate(n.videoPlayerId);
    }
    function d(e) {
      ...
      isNaN(t) && !isNaN(o) && (t = o),
        isNaN(t) || r(i, t),
        l || n.play(),
        n.initialAnimationSet &&
          setTimeout(function () {
            n.displayOptions.layoutControls.playPauseAnimation =
              n.initialAnimationSet;
          }, 200),
        (n.fluidPseudoPause = !1);
    }
  },
  onVolumebarMouseDown: function (i) {
    function n(e, t) {
      var i = document.getElementById(e),
        n = document.getElementById(e + "_fluid_control_volume_container")
          .clientWidth,
        o = fluidPlayerClass.getInstanceById(e);
      if (n) {
        var a = t / n;
        a < 0.05 ? ((a = 0), (i.muted = !0)) : 0.95 < a && (a = 1),
          i.muted && 0 < a && (i.muted = !1),
          o.setVolume(a);
      }
    }
    function o(e) {
      var t = fluidPlayerClass.getEventOffsetX(
        e,
        document.getElementById(i + "_fluid_control_volume_container")
      );
      n(i, t);
    }
    function a(e) {
  ...
  setVastList: function () {
    ...
    if (n.displayOptions.vastOptions.hasOwnProperty("adList"))
      for (var r in n.displayOptions.vastOptions.adList)
        (adItem = n.displayOptions.vastOptions.adList[r]),
          (t = adItem),
          (i = void 0),
          (i = !1),
          t.vastTag ||
            (n.announceLocalError(
              102,
              '"vastTag" property is missing from adList.'
            ),
            (i = !0)),
          t.roll ||
            (n.announceLocalError(102, '"roll" is missing from adList.'),
            (i = !0)),
          -1 === n.availableRolls.indexOf(t.roll) &&
            (n.announceLocalError(
              102,
              "Only " + n.availableRolls.join(",") + " rolls are supported."
            ),
            (i = !0)),
          t.size &&
            -1 === n.supportedNonLinearAd.indexOf(t.size) &&
            (n.announceLocalError(
              102,
              "Only " +
                n.supportedNonLinearAd.join(",") +
                " size are supported."
            ),
            (i = !0)),
          i
            ? n.announceLocalError(102, "Wrong adList parameters.")
            : ((id = "ID" + l),
              (o[id] = Object.assign({}, a)),
              (o[id] = Object.assign(
                o[id],
                n.displayOptions.vastOptions.adList[r]
              )),
              "midRoll" == adItem.roll && (o[id].error = e("midRoll", adItem)),
              (o[id].id = id),
              l++);
    n.adList = o;
  },
  ...
  volumeChange: function (e, t) {
    ...
    "asc" == t ? (i += 0.05) : "desc" == t && (i -= 0.05),
      i < 0.05 ? (i = 0) : 0.95 < i && (i = 1),
      this.setVolume(i);
  },
  currentTimeChange: function (e, t) {
    ...
    if (!i.isCurrentlyPlayingAd) {
      ...
      n.currentTime = i.getNewCurrentTimeValueByKeyCode(
        t,
        n.currentTime,
        n.duration
      );
  ...
  handleMouseleave: function (e) {
    ...
    (void 0 !== e.clientX &&
      document
        .getElementById("fluid_video_wrapper_" + t)
        .contains(document.elementFromPoint(e.clientX, e.clientY))) ||
      (i.hideControlBar.call(this), i.hideTitle.call(this));
  },
  ...
  keyboardControl: function () {
    var n = this;
    document
      .getElementById("fluid_video_wrapper_" + n.videoPlayerId)
      .addEventListener("click", n.handleMouseenterForKeyboard, !1),
      window.addEventListener("click", function (e) {
        ...
        document
          .getElementById("fluid_video_wrapper_" + t)
          .contains(e.target) ||
          e.target.id == "skipHref_" + t ||
          (document.removeEventListener("keydown", i.captureKey, !0),
          delete i.captureKey,
          i.theatreMode && !i.theatreModeAdvanced && i.theatreToggle());
      });
  },
  initialPlay: function () {
    ...
    t.firstPlayLaunched ||
      (t.playPauseToggle(e), e.removeEventListener("play", t.initialPlay));
  },
  playPauseToggle: function (e) {
    ...
    if (i && 0 != n.length) {
      ...
      i &&
        ...
        t.displayOptions.vastOptions.vastAdvanced.noVastVideoCallback()),
        e.paused
          ? (t.dashPlayer ? t.dashPlayer.play() : e.play(),
            this.playPauseAnimationToggle(!0))
          : i || (e.pause(), this.playPauseAnimationToggle(!1)),
        t.toggleOnPauseAd();
    function a() {
    ...
    if (i) {
      ...
      l && l.parentNode.removeChild(l),
        0 < t.mainVideoDuration
          ? a()
          : e.addEventListener("mainVideoDurationSet", a);
    }
    t.adTimer();
    var r = document.getElementById(t.videoPlayerId + "_fluid_html_on_pause");
    r &&
      !t.isCurrentlyPlayingAd &&
      (e.paused ? (r.style.display = "flex") : (r.style.display = "none"));
  },
  setCustomControls: function () {
    ...
    document
      ...
      .addEventListener(
        "click",
        function () {
          t.firstPlayLaunched || e.removeEventListener("play", t.initialPlay),
            t.playPauseToggle(e);
        },
        !1
      ),
      ...
      e.addEventListener("timeupdate", function () {
        t.contolProgressbarUpdate(t.videoPlayerId),
          t.contolDurationUpdate(t.videoPlayerId);
      });
    var i = fluidPlayerClass.getMobileOs().userOs ? "touchstart" : "mousedown";
    document
      .getElementById(t.videoPlayerId + "_fluid_controls_progress_container")
      .addEventListener(
        i,
        function (e) {
      ...
      document
        .getElementById(t.videoPlayerId + "_fluid_control_volume_container")
        .addEventListener(
          i,
          function (e) {
      ...
      document
        .getElementById(t.videoPlayerId + "_fluid_control_mute")
        .addEventListener("click", function () {
          t.muteToggle(t.videoPlayerId);
        }),
      t.setBuffering(),
      document
        .getElementById(t.videoPlayerId + "_fluid_control_fullscreen")
        .addEventListener("click", function () {
          t.fullscreenToggle();
        }),
      t.displayOptions.layoutControls.allowTheatre && !t.isInIframe
        ? document
            .getElementById(t.videoPlayerId + "_fluid_control_theatre")
            .addEventListener("click", function () {
  ...
  createTimePositionPreview: function () {
    ...
    if (a.showTimeOnHover) {
      var e = document.getElementById(
          a.videoPlayerId + "_fluid_controls_progress_container"
        ),
        t = document.createElement("div");
      (t.id = a.videoPlayerId + "_fluid_timeline_preview"),
          ...
          .addEventListener(
            ...
            function (e) {
              var t = document.getElementById(
                ...
                i = t.clientWidth,
                n = document.getElementById(
                  a.videoPlayerId + "_fluid_timeline_preview"
                ),
                o = fluidPlayerClass.getEventOffsetX(e, t);
              (hoverSecondQ = (a.currentVideoDuration * o) / i),
                (showad = a.formatTime(hoverSecondQ)),
                (n.innerText = showad),
                (n.style.display = "block"),
                (n.style.left = (hoverSecondQ / l.duration) * 100 + "%");
            },
            !1
          ),
        document
  ...
  setCustomContextMenu: function () {
    var e = this,
      ...
      i = document.getElementById("fluid_video_wrapper_" + e.videoPlayerId),
      n = document.createElement("div");
    (n.id = e.videoPlayerId + "_fluid_context_menu"),
      (n.className = "fluid_context_menu"),
      ...
      i.addEventListener(
        ...
        function (e) {
          e.preventDefault(),
            (n.style.left = fluidPlayerClass.getEventOffsetX(e, t) + "px"),
            (n.style.top = fluidPlayerClass.getEventOffsetY(e, t) + "px"),
            (n.style.display = "block");
        },
        !1
      ),
  ...
  setDefaultLayout: function () {
    ...
    (document.getElementById(
      ...
      " fluid_player_layout_" + e.displayOptions.layoutControls.layout),
      t.removeAttribute("controls"),
      e.setCustomContextMenu();
    var i = "";
    e.checkShouldDisplayVolumeBar() || (i = " no_volume_bar");
    var n = document.createElement("div");
    (n.id = e.videoPlayerId + "_fluid_controls_container"),
      (n.className = "fluid_controls_container" + i),
      (n.innerHTML = e.generateCustomControlTags()),
      t.parentNode.insertBefore(n, t.nextSibling);
    var o = document.createElement("div");
    (o.className = "vast_video_loading"),
      (o.id = "vast_video_loading_" + e.videoPlayerId),
    ...
    var a = 100,
      l = setInterval(function () {
        a
          ? e.checkIfVolumebarIsRendered()
            ? (clearInterval(l), e.contolVolumebarUpdate(e.videoPlayerId))
            : a--
          : clearInterval(l);
      }, 100);
    e.initHtmlOnPauseBlock(),
      e.setCustomControls(),
      e.setupThumbnailPreview(),
      e.createTimePositionPreview(),
      e.posterImage(),
      e.initPlayButton(),
      e.setVideoPreload(),
      e.createPlaybackList(),
      e.createDownload();
  },
  checkIfVolumebarIsRendered: function () {
    var e = document.getElementById(
        this.videoPlayerId + "_fluid_control_volume_currentpos"
      ),
      t = document.getElementById(this.videoPlayerId + "_fluid_control_volume")
        .clientWidth;
  ...
  setupThumbnailPreviewVtt: function () {
    var d = this;
    d.sendRequest(
      d.displayOptions.layoutControls.timelinePreview.file,
      !0,
      d.displayOptions.vastOptions.vastTimeout,
      function () {
        var e = this;
        if (
          ...
          d.timelinePreviewData = (function (e) {
            ...
            for (
              ...
              2 === (i = e.cues[o].text.split("#")).length &&
                ...
                ((d.displayOptions.layoutControls.timelinePreview.spriteImage = !0),
                (a = parseInt(n[0])),
                (l = parseInt(n[1])),
                (r = parseInt(n[2])),
                (s = parseInt(n[3]))),
                !d.displayOptions.layoutControls.timelinePreview
                  .spriteRelativePath ||
                -1 ===
                  d.displayOptions.layoutControls.timelinePreview.file.indexOf(
                    "/"
                  ) ||
                (void 0 !==
                  d.displayOptions.layoutControls.timelinePreview.sprite &&
                  "" != d.displayOptions.layoutControls.timelinePreview.sprite)
                  ? (imageUrl = d.displayOptions.layoutControls.timelinePreview
                      .sprite
                      ? d.displayOptions.layoutControls.timelinePreview.sprite
                      : i[0])
                  : ((imageUrl = d.displayOptions.layoutControls.timelinePreview.file.substring(
                      0,
                      d.displayOptions.layoutControls.timelinePreview.file.lastIndexOf(
                        "/"
                      )
                    )),
                    (imageUrl += "/" + i[0])),
  ...
  generateTimelinePreviewTags: function () {
    var e = document.getElementById(
        this.videoPlayerId + "_fluid_controls_progress_container"
      ),
      t = document.createElement("div");
    (t.id = this.videoPlayerId + "_fluid_timeline_preview_container"),
      (t.className = "fluid_timeline_preview_container"),
      (t.style.display = "none"),
      (t.style.position = "absolute"),
      e.appendChild(t);
  ...
  getThumbnailCoordinates: function (e) {
    ...
    if (t.timelinePreviewData.length)
      for (var i = 0; i < t.timelinePreviewData.length; i++)
        if (
          e >= t.timelinePreviewData[i].startTime &&
          e <= t.timelinePreviewData[i].endTime
        )
          return t.timelinePreviewData[i];
    return !1;
  },
  drawTimelinePreview: function (e) {
    var t = this,
      i = document.getElementById(
        t.videoPlayerId + "_fluid_timeline_preview_container"
      ),
      n = document.getElementById(
        t.videoPlayerId + "_fluid_timeline_preview_container_shadow"
      ),
      o = document.getElementById(
        t.videoPlayerId + "_fluid_controls_progress_container"
      ),
          ...
          !(n.style.display = "block") !== s
            ? ((i.style.width = s.w + "px"),
              ...
              (i.style.background =
                ...
                s.y +
                "px"),
              (i.style.left = l - s.w / 2 + "px"),
              (i.style.display = "block"),
              t.displayOptions.layoutControls.timelinePreview.spriteImage ||
  ...
  setupThumbnailPreview: function () {
    var i = this;
    if (
      i.displayOptions.layoutControls.timelinePreview &&
      "string" == typeof i.displayOptions.layoutControls.timelinePreview.file &&
      "string" == typeof i.displayOptions.layoutControls.timelinePreview.type
    ) {
      switch (i.displayOptions.layoutControls.timelinePreview.type) {
        case "VTT":
          fluidPlayerClass.requestScript(
            ...
            i.setupThumbnailPreviewVtt.bind(this)
          );
          var e = "mousemove",
            t = "mouseleave";
          i.mobileInfo.userOs && ((e = "touchmove"), (t = "touchend")),
            document
              .getElementById(
                i.videoPlayerId + "_fluid_controls_progress_container"
              )
              .addEventListener(e, i.drawTimelinePreview.bind(i), !1),
            document
              .getElementById(
                i.videoPlayerId + "_fluid_controls_progress_container"
              )
              .addEventListener(
                ...
                function (e) {
                  ...
                  (void 0 !== e.clientX &&
                    ...
                    ((document.getElementById(
                      i.videoPlayerId + "_fluid_timeline_preview_container"
                    ).style.display = "none"),
                    (document.getElementById(
                      i.videoPlayerId +
  ...
  setupPlayerWrapper: function () {
    var e = document.getElementById(this.videoPlayerId),
      t = document.createElement("div");
    (t.className = fluidPlayerClass.isTouchDevice()
      ? "fluid_video_wrapper mobile"
      : "fluid_video_wrapper"),
      (t.id = "fluid_video_wrapper_" + this.videoPlayerId),
      this.displayOptions.layoutControls.fillToContainer
  ...
  onErrorDetection: function () {
    ...
    this.networkState === this.NETWORK_NO_SOURCE &&
      e.isCurrentlyPlayingAd &&
      e.playMainVideoWhenVastFails(401);
  },
  createVideoSourceSwitch: function () {
    ...
    if (
      ...
      (a.videoSources = t),
      1 < a.videoSources.length)
    ) {
      var i = document.getElementById(
          a.videoPlayerId + "_fluid_control_video_source"
        ),
        r = !1,
        s = document.createElement("div");
      (s.id = a.videoPlayerId + "_fluid_control_video_source_list"),
        (s.className = "fluid_video_sources_list"),
      ...
      a.videoSources.forEach(function (e) {
        ...
        if ("iOS" != a.mobileInfo.userOs || "mkv" != t) {
          ...
          d = !1;
          var o = document.createElement("div");
          (o.id = "source_" + a.videoPlayerId + "_" + e.title),
            (o.className = "fluid_video_source_list_item"),
            (o.innerHTML =
            ...
            o.addEventListener("click", function (e) {
              ...
              for (
                var t = this,
                  i = document.getElementsByClassName("source_button_icon"),
                  n = 0;
                n < i.length;
                n++
              )
                i[n].className = i[n].className.replace("source_selected", "");
              (t.firstChild.className += " source_selected"),
                a.videoSources.forEach(function (e) {
                  e.title == t.innerText.replace(/(\r\n\t|\n|\r\t)/gm, "") &&
                    (a.setBuffering(),
                    a.setVideoSource(e.url),
                    (a.fluidStorage.fluidQuality = e.title));
                }),
  ...
  openCloseVideoSourceSwitch: function () {
    var t = document.getElementById(
        this.videoPlayerId + "_fluid_control_video_source_list"
      ),
      i = document.getElementById(
        this.videoPlayerId + "_fluid_control_video_source"
      );
  ...
  setVideoSource: function (e) {
    var t = this,
      i = document.getElementById(t.videoPlayerId);
    if ("iOS" == t.mobileInfo.userOs && 0 < e.indexOf(".mkv"))
      return (
        console.log("[FP_ERROR] .mkv files not supported by iOS devices."), !1
      );
    ...
    var i = document.getElementById(this.videoPlayerId),
      ...
      o = function () {
        (i.currentTime = e),
          ...
          "iOS" == n.mobileInfo.userOs && i.addEventListener("playing", a),
          t && i.play(),
  ...
  initTitle: function () {
    ...
    if (this.displayOptions.layoutControls.title) {
      var t = document.createElement("div");
      (t.id = this.videoPlayerId + "_title"),
        e.parentNode.insertBefore(t, null),
        (t.innerHTML += this.displayOptions.layoutControls.title),
        t.classList.add("fp_title");
    }
  },
  hasTitle: function () {
  ...
  hideTitle: function () {
    var e = fluidPlayerClass.getInstanceIdByWrapperId(this.getAttribute("id")),
      ...
      i =
        ...
        document.getElementById(t.videoPlayerId + "_title"));
  ...
  initLogo: function () {
    ...
    if (e.displayOptions.layoutControls.logo.imageUrl) {
      ...
      e.displayOptions.layoutControls.logo.hideWithControls &&
        (n = "initial_controls_show"),
        i.classList.add(n, "fp_logo");
      var o = document.createElement("img");
      (o.id = e.videoPlayerId + "_logo_image"),
        e.displayOptions.layoutControls.logo.imageUrl &&
          (o.src = e.displayOptions.layoutControls.logo.imageUrl),
        (o.style.position = "absolute"),
        (o.style.margin = e.displayOptions.layoutControls.logo.imageMargin);
      var a = e.displayOptions.layoutControls.logo.position.toLowerCase();
      -1 !== a.indexOf("bottom") ? (o.style.bottom = 0) : (o.style.top = 0),
        -1 !== a.indexOf("right") ? (o.style.right = 0) : (o.style.left = 0),
        e.displayOptions.layoutControls.logo.opacity &&
          (o.style.opacity = e.displayOptions.layoutControls.logo.opacity),
        null !== e.displayOptions.layoutControls.logo.clickUrl &&
          ((o.style.cursor = "pointer"),
          o.addEventListener("click", function () {
            window
              .open(e.displayOptions.layoutControls.logo.clickUrl, "_blank")
              .focus();
          })),
        e.displayOptions.layoutControls.logo.mouseOverImageUrl &&
          (o.addEventListener(
            "mouseover",
            function () {
    ...
    if (
      ...
      (e.id = t.videoPlayerId + "_fluid_html_on_pause"),
        ...
        t.displayOptions.layoutControls.htmlOnPauseBlock.width &&
          (e.style.width =
            t.displayOptions.layoutControls.htmlOnPauseBlock.width + "px"),
        t.displayOptions.layoutControls.htmlOnPauseBlock.height &&
          (e.style.height =
            t.displayOptions.layoutControls.htmlOnPauseBlock.height + "px"),
        i.parentNode.insertBefore(e, null);
    }
  },
  initPlayButton: function () {
    ...
    i.addEventListener("click", n),
      e.displayOptions.layoutControls.playButtonShowing ||
        (document
  ...
  userActivityChecker: function () {
    ...
    t.newActivity = null;
    function n(e) {
      ("touchstart" !== e.type && "mousedown" !== e.type) || (o = !0),
        ("touchend" !== e.type && "mouseup" !== e.type) || (o = !1),
        (t.newActivity = !0);
    }
    var o = !1;
      ...
      if (!0 === t.newActivity) {
        ...
        clearTimeout(t.inactivityTimeout),
          (t.inactivityTimeout = setTimeout(function () {
            !0 !== t.newActivity
              ? ((t.isUserActive = !1),
                (e = new CustomEvent("userInactive")),
                i.dispatchEvent(e))
              : clearTimeout(t.inactivityTimeout);
    ...
    for (
      var a = fluidPlayerClass.isTouchDevice()
  ...
  hasControlBar: function () {
    return !!document.getElementById(
      this.videoPlayerId + "_fluid_controls_container"
    );
  },
  ...
  setVideoPreload: function () {
    document
      .getElementById(this.videoPlayerId)
      .setAttribute("preload", this.displayOptions.layoutControls.preload);
  },
  hideControlBar: function () {
    var e = fluidPlayerClass.getInstanceIdByWrapperId(this.getAttribute("id")),
      ...
      i = document.getElementById(e);
    if (
      (t.isCurrentlyPlayingAd && !i.paused && t.toggleAdCountdown(!0),
      t.hasControlBar())
    ) {
      ...
      t.displayOptions.layoutControls.controlBar.animated
        ? (n.classList.remove("fade_in"),
          n.classList.add("fade_out"),
          o && (o.classList.remove("fade_in"), o.classList.add("fade_out")))
  ...
  showControlBar: function () {
    var e = fluidPlayerClass.getInstanceIdByWrapperId(this.getAttribute("id")),
      ...
      i = document.getElementById(e);
    if (
      (t.isCurrentlyPlayingAd && !i.paused && t.toggleAdCountdown(!1),
      t.hasControlBar())
    ) {
      var n = document.getElementById(
          t.videoPlayerId + "_fluid_controls_container"
        ...
        o = document.getElementById(t.videoPlayerId + "_logo");
      t.displayOptions.layoutControls.controlBar.animated
        ? (n.classList.remove("fade_out"),
          n.classList.add("fade_in"),
          o && (o.classList.remove("fade_out"), o.classList.add("fade_in")))
        : ((n.style.display = "block"), o && (o.style.display = "block"));
    }
  ...
  linkControlBarUserActivity: function () {
    var e = this,
      t = document.getElementById(e.videoPlayerId);
    t.addEventListener("userInactive", e.hideControlBar),
      t.addEventListener("userActive", e.showControlBar),
      t.addEventListener("userInactive", e.hideTitle),
      t.addEventListener("userActive", e.showTitle);
  },
  initMute: function () {
    !0 === this.displayOptions.layoutControls.mute &&
      (document.getElementById(this.videoPlayerId).volume = 0);
  },
  initLoop: function () {
    var e = document.getElementById(this.videoPlayerId);
    null !== this.displayOptions.layoutControls.loop
      ? (e.loop = this.displayOptions.layoutControls.loop)
      : e.loop && (this.displayOptions.layoutControls.loop = !0);
  },
        ...
        if (0 < e)
          for (var t = 0; t < i.buffered.length; t++)
            if (i.buffered.start(i.buffered.length - 1 - t) < i.currentTime) {
              (n.style.width =
                (i.buffered.end(i.buffered.length - 1 - t) / e) * 100 + "%"),
                i.buffered.end(i.buffered.length - 1 - t) / e == "1" &&
                  clearInterval(o);
              break;
            }
      });
  ...
  createPlaybackList: function () {
    ...
    if (i.displayOptions.layoutControls.playbackRateEnabled) {
      var e = document.getElementById(
          i.videoPlayerId + "_fluid_control_playback_rate"
        ),
        n = document.createElement("div");
      (n.id = i.videoPlayerId + "_fluid_control_video_playback_rate"),
          ...
          (t.className = "fluid_video_playback_rates_item"),
            ...
            t.addEventListener("click", function (e) {
              e.stopPropagation(),
                ...
                i.setPlaybackSpeed(playbackRate),
  ...
  openCloseVideoPlaybackRate: function () {
    var e = document.getElementById(
        this.videoPlayerId + "_fluid_control_video_playback_rate"
      ),
      t = document.getElementById(
        this.videoPlayerId + "_fluid_control_playback_rate"
      );
  ...
  createDownload: function () {
    var t = this,
      e = document.getElementById(
        this.videoPlayerId + "_fluid_control_download"
      );
  ...
  theatreToggle: function () {
    if (!this.isInIframe) {
      if (
        ...
        null != e && null != t
          ? (this.theatreMode ? e.classList.remove(t) : e.classList.add(t),
    ...
    if (this.theatreMode)
      e.classList.remove("fluid_theatre_mode"),
        ...
        this.displayOptions.layoutControls.fillToContainer
          ...
          : ((e.style.width = this.originalWidth + "px"),
            (e.style.height = this.originalHeight + "px"));
    else {
      ...
      switch (
        ...
        (e.style.marginTop =
          this.displayOptions.layoutControls.theatreSettings.marginTop + "px"),
        ...
        case "center":
          "string" == typeof t && "%" == t.substr(t.length - 1)
            ...
            ? (i =
                (((screen.width - parseInt(t.substring(0, t.length - 2))) /
                  screen.width) *
                  100) /
                  2 +
                "%")
  ...
  posterImage: function () {
    if (this.displayOptions.layoutControls.posterImage) {
      ...
      if (
        ((e.id = this.videoPlayerId + "_fluid_pseudo_poster"),
        (e.className = "fluid_pseudo_poster"),
        -1 ===
          ["auto", "contain", "cover"].indexOf(
            this.displayOptions.layoutControls.posterImageSize
          ))
      )
      ...
      (e.style.background =
        "url('" +
        this.displayOptions.layoutControls.posterImage +
        "') center center / " +
        this.displayOptions.layoutControls.posterImageSize +
        " no-repeat black"),
        document
          .getElementById(this.videoPlayerId)
          .parentNode.insertBefore(e, null);
    }
  },
  initialiseStreamers: function () {
    switch (
      (this.detachStreamers(), this.displayOptions.layoutControls.mediaType)
    ) {
      case "application/dash+xml":
        this.dashScriptLoaded
          ? this.initialiseDash()
      ...
      case "application/x-mpegURL":
        this.hlsScriptLoaded || window.Hls
          ? this.initialiseHls()
  ...
  initialiseDash: function () {
    if ("function" == typeof (window.MediaSource || window.WebKitMediaSource)) {
      var e = this.autoplayAfterAd
          ? this.displayOptions.layoutControls.autoPlay
          : this.autoplayAfterAd,
        t = dashjs.MediaPlayer().create();
      t.getDebug().setLogToBrowserConsole(!1),
        t.initialize(
      ...
      this.nextSource(),
        console.log(
          "[FP_ERROR] Media type not supported by this browser. (application/dash+xml)"
        );
  },
  initialiseHls: function () {
    if (Hls.isSupported()) {
      var e = new Hls(this.displayOptions.hlsjsConfig);
      e.attachMedia(document.getElementById(this.videoPlayerId)),
        e.loadSource(this.originalSrc),
        (this.hlsPlayer = e),
        !this.firstPlayLaunched &&
          this.displayOptions.layoutControls.autoPlay &&
          document.getElementById(this.videoPlayerId).play();
    } else
      this.nextSource(),
        console.log(
          "[FP_ERROR] Media type not supported by this browser. (application/x-mpegURL)"
        );
  },
  detachStreamers: function () {
    this.dashPlayer
      ? (this.dashPlayer.reset(), (this.dashPlayer = !1))
      : this.hlsPlayer && (this.hlsPlayer.detachMedia(), (this.hlsPlayer = !1));
  },
  nextSource: function () {
    var e = document
      .getElementById(this.videoPlayerId)
    ...
    if (e.length)
      for (var t = 0; t < e.length - 1; t++)
        if (
          e[t].getAttribute("src") == this.originalSrc &&
          e[t + 1].getAttribute("src")
        )
          return void this.setVideoSource(e[t + 1].getAttribute("src"));
    return null;
  },
  inIframe: function () {
    try {
  ...
  setPersistentSettings: function () {
    if ("undefined" != typeof Storage && "undefined" != typeof localStorage) {
      if (
        ...
        void 0 !== this.fluidStorage.fluidVolume &&
          this.displayOptions.layoutControls.persistentSettings.volume &&
          (this.setVolume(this.fluidStorage.fluidVolume),
          void 0 !== this.fluidStorage.fluidMute &&
            "true" == this.fluidStorage.fluidMute &&
            this.muteToggle(this.videoPlayerId)),
        void 0 !== this.fluidStorage.fluidQuality &&
        ...
        var e = document.getElementById(
            "source_" +
              this.videoPlayerId +
              "_" +
              this.fluidStorage.fluidQuality
          ),
          t = document.getElementById(
            this.videoPlayerId + "_fluid_control_video_source"
          );
  ...
  init: function (e, t) {
    ...
    (i.vastOptions = { tracking: [], stopTracking: [] }),
    (i.videoPlayerId = e),
    ...
    (i.displayOptions = {
      ...
      hlsjsConfig: { p2pConfig: { logLevel: !1 } },
      captions: {
        play: "Play",
        pause: "Pause",
        mute: "Mute",
    ...
    i.setupPlayerWrapper(),
      ...
      (i.initialAnimationSet =
        i.displayOptions.layoutControls.playPauseAnimation),
      i.handleFullscreen(),
      i.initLogo(),
      i.initTitle(),
      i.initMute(),
      ...
      try {
        null != (e = l.apply(this, arguments)) &&
          ...
          (t.promiseTimeout = setTimeout(function () {
            !1 === t.isPlayingMedia &&
              t.announceLocalError(204, "Timeout error. Failed to play video.");
          }, 5e3)));
      } catch (e) {
    ...
    if (
      ...
      i.displayOptions.layoutControls.autoPlay &&
        !i.dashScriptLoaded &&
        !i.hlsScriptLoaded)
    ) {
    ...
    i.mobileInfo.userOs
      ? (i.hideControlBar.call(d),
        d.addEventListener("touchstart", i.showControlBar, !1))
      : (d.addEventListener("mouseleave", i.handleMouseleave, !1),
        d.addEventListener("mouseenter", i.showControlBar, !1),
        d.addEventListener("mouseenter", i.showTitle, !1)),
      i.displayOptions.layoutControls.keyboardControl && i.keyboardControl(),
      i.displayOptions.layoutControls.controlBar.autoHide &&
  ...
  setPlaybackSpeed: function (e) {
    this.isCurrentlyPlayingAd ||
      ((document.getElementById(this.videoPlayerId).playbackRate = e),
      (this.fluidStorage.fluidSpeed = e));
  },
  setVolume: function (e) {
    (document.getElementById(this.videoPlayerId).volume = e),
      (this.latestVolume = e),
      (this.fluidStorage.fluidVolume = e);
  },
  ...
  setHtmlOnPauseBlock: function (e) {
    ...
    var t = document.getElementById(
      this.videoPlayerId + "_fluid_html_on_pause"
    );
    if (t)
      (t.innerHTML = e.html),
      ...
      var i = document.getElementById(player.videoPlayerId),
        n = document.createElement("div");
      (n.id = player.videoPlayerId + "_fluid_html_on_pause"),
        (n.className = "fluid_html_on_pause"),
        (n.style.display = "none"),
        (n.innerHTML = e.html),
        (n.onclick = function () {
        ...
        i.parentNode.insertBefore(n, null);
    }
  },
  toggleControlBar: function (e) {
    ...
    e
      ? (t.className += " initial_controls_show")
      : (t.className = t.className.replace(" initial_controls_show", ""));
  },
  toggleFullscreen: function (e) {
    this.fullscreenMode != e &&
      (e && this.theatreMode && this.theatreToggle(), this.fullscreenToggle());
  },
  on: function (e, t) {
    var i = document.getElementById(this.videoPlayerId),
      n = this;
  ...
  toggleLogo: function (e) {
    ...
    var t = document.getElementById(this.videoPlayerId + "_logo");
    (this.displayOptions.layoutControls.logo.imageUrl = e.imageUrl
      ? e.imageUrl
      : null),
      (this.displayOptions.layoutControls.logo.position = e.position
        ? e.position
        : "top left"),
      (this.displayOptions.layoutControls.logo.clickUrl = e.clickUrl
        ? e.clickUrl
        : null),
      (this.displayOptions.layoutControls.logo.opacity = e.opacity
        ? e.opacity
        : 1),
      (this.displayOptions.layoutControls.logo.mouseOverImageUrl = e.mouseOverImageUrl
        ? e.mouseOverImageUrl
        : null),
      (this.displayOptions.layoutControls.logo.imageMargin = e.imageMargin
        ? e.imageMargin
        : "2px"),
      (this.displayOptions.layoutControls.logo.hideWithControls =
        !!e.hideWithControls && e.hideWithControls),
      (this.displayOptions.layoutControls.logo.showOverAds =
