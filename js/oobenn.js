  ...
  // User Going or Interested
   ...
   $("body").on("click",".movg", function(){
	   ...
	   $.ajax({
		  ...
		  data: data,
		  beforeSend: function() {
			$(".newnotifications_").prepend("<div class='prog-colm-which panel-flex'><div class='prog-bar-colm'><div class='progressmi'><span class='indeterminatespost'></span></div></div></div>");
		  },
		  success: function(response) {
			  if(response == 1){
			     $(".iev"+eventID).fadeOut();
