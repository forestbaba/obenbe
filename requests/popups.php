...
if(isset($_POST['popUp'])){
   ...
   if($popUpType == 'deletePostad'){
	$postID = mysqli_real_escape_string($db, $_POST['pid']);
	$postUserName = mysqli_real_escape_string($db, $_POST['punm']); 
	echo '<div class="confirmBoxContainer"><div class="ConfirmBoxWrapper"><div class="ConfirmBoxMiddle"><div class="are_you_sure">'.$page_Lang['sure_want_to_delete_this_post'][$dataUserPageLanguage].'</div><div class="confirmButtons"><div class="tab_frame"><button class="ui_button btn_0 chrome " data-btn-id="0"><span>'.$page_Lang['cancel'][$dataUserPageLanguage].'</span></button></div><div class="tab_frame focus init_focus"><button class="ui_button btn_1 chrome blue delete_this_post" data-post="'.$postID.'" data-user="'.$postUserName.'" data-type="deletePostad"><span>'.$page_Lang['sure_delete'][$dataUserPageLanguage].'</span></button></div></div></div></div></div>';
   } 
   ...
   if($popUpType == 'deleteAdsAd'){
	...
	if($popUpType == 'report_delete'){
	 ...
	 if($popUpType == 'deleteOrder'){
         $lnid = mysqli_real_escape_string($db, $_POST['anid']); 
		echo '<div class="confirmBoxContainer"><div class="ConfirmBoxWrapper"><div class="ConfirmBoxMiddle"><div class="are_you_sure">'.$page_Lang['are_you_sure_want_to_delete_this_order'][$dataUserPageLanguage].'</div><div class="confirmButtons"><div class="tab_frame"><button class="ui_button btn_0 chrome " data-btn-id="0"><span>'.$page_Lang['cancel'][$dataUserPageLanguage].'</span></button></div><div class="tab_frame focus init_focus"><button class="ui_button btn_1 chrome blue delete_this_order" id="'.$lnid.'" data-post="'.$lnid.'" data-type="delete_this_order"><span>'.$page_Lang['sure_delete'][$dataUserPageLanguage].'</span></button></div></div></div></div></div>';
	 }
	 if($popUpType == 'deleteOrderFromCart'){
         $lnid = mysqli_real_escape_string($db, $_POST['anid']); 
		echo '<div class="confirmBoxContainer"><div class="ConfirmBoxWrapper"><div class="ConfirmBoxMiddle"><div class="are_you_sure">'.$page_Lang['sure_you_want_to_this_product_from_user_cart'][$dataUserPageLanguage].'</div><div class="confirmButtons"><div class="tab_frame"><button class="ui_button btn_0 chrome " data-btn-id="0"><span>'.$page_Lang['cancel'][$dataUserPageLanguage].'</span></button></div><div class="tab_frame focus init_focus"><button class="ui_button btn_1 chrome blue delete_this_order_from_cart" id="'.$lnid.'" data-post="'.$lnid.'" data-type="delete_this_order_from_cart"><span>'.$page_Lang['sure_delete'][$dataUserPageLanguage].'</span></button></div></div></div></div></div>';
	 }
