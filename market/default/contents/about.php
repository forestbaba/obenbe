...
<div class="market_info">
   <div class="market_info_header"><?php echo $page_Lang['about_marketplc'][$dataUserPageLanguage]; ?> <?php echo $m_editButton; ?></div>
   <div class="market_info_box">
         <div class="box_header"><?php echo $page_Lang['about_marketplc'][$dataUserPageLanguage]; ?></div>
         <div class="market_global_box"><?php echo strip_unsafe(styletext($marketAbout)); ?></div>
         <div class="box_header"><?php echo $page_Lang['market_phone'][$dataUserPageLanguage]; ?></div>
         <div class="market_global_box"><?php echo format_phone_us($marketPhone); ?></div>
         <div class="box_header"><?php echo $page_Lang['market_email'][$dataUserPageLanguage]; ?></div>
         <div class="market_global_box"><?php echo $marketEmail; ?></div>
         <div class="box_header"><?php echo $page_Lang['market_addresss'][$dataUserPageLanguage]; ?></div>
