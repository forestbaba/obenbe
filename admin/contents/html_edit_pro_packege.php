<div class="search_user_filter_container openSocial">
  <div class="shareonSocial">
    ...
    <div class="search_user_filter_wrap">
      ...
      <div class="column_set_input_box"><input type="text" class="column_inputField chng" id="updatepackageTitle" value="<?php echo $page_Lang[$ItemPriceType][$dataUserPageLanguage];?>" placeholder="<?php echo $page_Lang['propackagetitlelanguagekeyhere'][$dataUserPageLanguage];?>"></div>
      </span>
      <!---->
      <!---->
      <span class="setting-box"> 
             <span class="setSettinginputTitle"><?php echo $page_Lang['newpackagedescription'][$dataUserPageLanguage];?></span>
      <div class="column_set_input_box"><input type="text" class="column_inputField chng" id="updatepackageDescription" value="<?php echo $page_Lang[$ItemPriceInfo][$dataUserPageLanguage];?>" placeholder="<?php echo $page_Lang['newpropackagedescription'][$dataUserPageLanguage];?>"></div>
      </span>
      <!---->
      <!---->
      <span class="setting-box"> 
