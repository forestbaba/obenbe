...
<div class="global_right_wrapper">
 ...
 <?php  
$limit = '10';
$countSql = "SELECT P.user_id_fk, P.post_type, U.user_id, U.user_status, COUNT(user_post_id) FROM dot_user_posts P INNER JOIN dot_users U ON P.user_id_fk = U.user_id WHERE U.user_status = '1' AND P.post_type = 'p_text' AND P.shared_post IS NULL";  
