                                  ...
                                  <div class="profileDetailsContainerGlobal">
                                     <!--ssssss-->
                                      <div class="life_info_form">
                                         <h1 class="info_title"><?php echo $page_Lang['user_type_edit'][$dataUserPageLanguage];?></h1> 
                                         <div class="info_form_items" id="utyp">
                                             <!--Item STARTED-->  
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="isAdmin" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUserType == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['user_is_admin'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUserType == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['normal_user'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             ...
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox"> 
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="proTypeis" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileProType == '1' ? "selected='selected'":""; ?>>User is Pro</option>
                                                       <option value="0" <?php echo $userProfileProType == '0' ? "selected='selected'":""; ?>>User is Normal</option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                         ...
                                         <h1 class="info_title"><?php echo $page_Lang['user_share_settings'][$dataUserPageLanguage];?></h1> 
                                         <div class="info_form_items" id="urel">
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_text'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canText" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareText == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareText == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_image'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canImage" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareImage == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareImage == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_video'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canVideo" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareVideo == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareVideo == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_audio'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canAudio" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareAudio == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareAudio == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_link'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canLink" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareLink == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareLink == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_giphy'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canGiphy" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareGiphy == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareGiphy == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_which'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canWhichOne" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareWhichImage == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareWhichImage == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_location'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canLocation" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareLocation == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareLocation == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_befora_after'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canBefAf" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareBeforeAfter == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareBeforeAfter == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_product'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canProd" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareProduct == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareProduct == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_filter'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canFilt" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareFilter == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareFilter == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
                                             <!--Item FINISHED-->
                                             <!--Item STARTED--> 
                                             <div class="info_item_box _item_answer_profile_edit" style="color:#e53935; font-weight:400;"><?php echo $page_Lang['can_this_user_share_watermark'][$dataUserPageLanguage];?></div>
                                             <div class="info_item_box"> 
                                                <div class="info_item_answer globalSelectBox">
                                                  <span class="input-field col s12">
                                                   <select class="selectTheOption" data-type="canWatermark" data-user="<?php echo $userProfileID;?>">            
                                                       <option value="1" <?php echo $userProfileUsercanShareWatermark == '1' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can'][$dataUserPageLanguage];?></option>
                                                       <option value="0" <?php echo $userProfileUsercanShareWatermark == '0' ? "selected='selected'":""; ?>><?php echo $page_Lang['yes_user_can_not'][$dataUserPageLanguage];?></option> 
                                                    </select>
                                                    </span>
                                                </div>
                                             </div>
