   ...
   <div class="global_box_container_w bgc"> 
            ...
            <div class="create_ads_box_container_admin" id="sedpay">
                    ...
                    <div class="setSettingBoxText"><?php echo $page_Lang['p_live'][$dataUserPageLanguage];?></div>
                     ...
                     <!----> 
                       <span class="setting-box"> 
                           <span class="setSettinginputTitle"><?php echo $page_Lang['add_minimum_credit_amount'][$dataUserPageLanguage];?></span>  
                           <div class="column_set_input_box"><input type="text" class="column_inputField send_livebox" id="miminumcrediamount" style="padding-left:30px;" placeholder="<?php echo $page_Lang['write_minimum_credit_amount'][$dataUserPageLanguage];?>" value="<?php echo $minMonth;?>"></div>
                       </span>
                     <!---->
                   </span>
