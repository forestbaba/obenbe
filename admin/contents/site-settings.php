...
<div class="global_right_wrapper">
   <div class="global_box_container_w bgc">
        ...
        <div class="row-box-container" id="set_profile">
                ...
                <span class="setting-box">
                   <span class="setSettingBox">
                      <div class="ckbx-style-14">
                          <input type="checkbox" id="watermarkStatus" class="gstf" name="watermarkStatus" <?php echo $watermarkStatus == '1' ? "checked='checked'":""; echo $watermarkStatus == '0' ? "value='1'":"value='0'";?>><label for="watermarkStatus"></label>
                      </div>
                   </span>
                   <span class="setSettingBoxText"><?php echo $page_Lang['watermark_status'][$dataUserPageLanguage];?></span>
                   <span class="setSettingBoxInfoNote"><?php echo $page_Lang['watermark_status_note'][$dataUserPageLanguage];?></span>
                 </span>
                <!---->
               <!---->
               <span class="setting-box"> 
               ...
               <!---->
               <span class="setting-box"> 
                   <span class="setSettinginputTitle"><?php echo $page_Lang['ffmpeg_path'][$dataUserPageLanguage];?></span>  
                   <div class="column_set_input_box"><textarea class="column_textarea chng" id="tffmpeg" placeholder="<?php echo $page_Lang['ffmpeg_path_ect'][$dataUserPageLanguage];?>" style="overflow: hidden; word-wrap: break-word; resize: none; height: 86px;"><?php echo $websiteFFMPEGPath;?></textarea></div>
               </span>
               <!----> 
               <!----> 
       ...
       <!---->
        ...
        <div class="row-box-container">
               ...
               <!---->
               <span class="setting-box"> 
                   <span class="setSettinginputTitle">Test Email Address</span>  
                   <div class="column_set_input_box"><input type="text" class="column_inputField chng" id="tmail" placeholder="Write a Test Mail Address" value="<?php echo $defaultTestEmail;?>"></div>
               </span>
               <!----> 
               <!----> 
               <div class="setting-box">
