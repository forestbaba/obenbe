// JavaScript Document 
 ...
 //Active page link from settings page
  ...
  $(".selecDefaultLang , .selectTheOption , .selectTheColor , .afterscroll  , .selecDefaultFeeling, .selectTheOptionDayWeekMonthYear , .changeCurrency, .defCurr, .selectDefaultTheme , .sendEmailTo, .regions").livequery(function() { 
	$(this).formSelect();
  });
