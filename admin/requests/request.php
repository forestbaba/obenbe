...
/*Delete This Country*/
	...
	if ($requestType == 'paymenfee') {
		if (isset($_POST['paymfee'])) {
			$newpaymenFee = mysqli_real_escape_string($db, $_POST['paymfee']);
			$updatePaymentFee = $Dot->Dot_UpdatePaymentFee($uid, $newpaymenFee);
			if ($updatePaymentFee) {
